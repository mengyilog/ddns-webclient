...
if (isset($_SESSION[ 'valid_user' ])) {
	...
	if ( stripslashes($_POST[ 'zone' ]) && stripslashes($_POST[ 'host' ]) && stripslashes($_POST[ 'type' ]) && stripslashes($_POST[ 'ttl' ]) && stripslashes($_POST[ 'refresh' ]) && stripslashes($_POST[ 'retry' ]) && stripslashes($_POST[ 'expire' ]) && stripslashes($_POST[ 'minimum' ]) && stripslashes($_POST[ 'serial' ]) && stripslashes($_POST[ 'resp_person' ]) && stripslashes($_POST[ 'primary_ns' ]) ) {
		$insert_query = 'insert into dns_records(zone, host, type, data, ttl, mx_priority, refresh, retry, expire, minimum, serial, resp_person, primary_ns, user_id) values ("'.stripslashes($_POST[ 'zone' ]).'","'.stripslashes($_POST[ 'host' ]).'","'.stripslashes($_POST[ 'type' ]).'","'.stripslashes($_POST[ 'data' ]).'",'.stripslashes($_POST[ 'ttl' ]).',NULL,'.stripslashes($_POST[ 'refresh' ]).','.stripslashes($_POST[ 'retry' ]).','.stripslashes($_POST[ 'expire' ]).','.stripslashes($_POST[ 'minimum' ]).','.stripslashes($_POST[ 'serial' ]).',"'.stripslashes($_POST[ 'resp_person' ]).'","'.stripslashes($_POST[ 'primary_ns' ]).'",'.stripslashes($valid_user_row[ 'id' ]).')';
